        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Nascida no silêncio dos ateliers subterrâneos, {"MA’VIC"} foi
              criada com o intuito de trazer estilo e identidade para seu guarda
              roupa, focada no sentimento de se sentir jovem e revolucionário.
              Não apenas aplicamos pigmentos; cravamos narrativas visuais em
              superfícies que resistem ao tempo.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Nossa curadoria é pautada pela estética nostalgia Y2K, Retrô e o
              ROCK anos 2000 - um diálogo constante entre o clássico e o
              visceral. Cada peça que sai de nossa prensa carrega o peso da
              exclusividade e a precisão da obsessão.
            </p>
